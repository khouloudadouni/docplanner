            ...
            <div className="main-1">
                {this.state.bloc.map(el=>
                 <div>
                    ...
                    <div className="global_company">
                        <div className="div_title_global_company">
                            <p className="title_global_company">We are a global company
with local culture</p>
                        </div>
                        {this.state.title.map(el=>
                        <div className="img_global_company">
